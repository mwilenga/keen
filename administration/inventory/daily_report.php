                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel-heading">
                                ...
                                <div class="panel-body">
                                 <?php
                                 $s = mysql_query("select * from tms_items, tms_orders where tms_orders.prod_id = tms_items.id and tms_orders.date = '".$_SESSION['data']."'");
                                  $num = mysql_num_rows($s);
                                  if($num < 1){
                                   ?>
                                   <center><h3>Customer Orders Report on <?php echo $_SESSION['data']; ?></h3></center>
