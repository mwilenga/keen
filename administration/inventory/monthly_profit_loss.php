            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    ...
                    <div class="row" style="float: right;">
                       <a href="prof_loss_report.php"><span class="fa fa-sign-out">&nbsp;Back</span></a>
                       </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action = "" method = "POST">
                                ...
                                <div id="testTable">
                                <div class="row">
                                <h3>Profit and loss report on month <?php echo $_SESSION['month'];?></h3><hr>
                                <div class="col-md-6">
                                <h3>Income</h3>
                                 <?php
                                 $mon = date('m');
                                 $s = mysql_query("select * from tms_income where month = '".$_SESSION['month']."'");
                                 ...
                                 ?>
                                    ...
                                    <div class="row">
                                    <?php
                                    $ai = mysql_query("select sum(price) as total_income from tms_income where month = '".$_SESSION['month']."'");
                                ...
                                <div class="col-md-6">
                                <?php
                                 $q = mysql_query("select * from tms_expenses where month = '".$_SESSION['month']."'");
                                  $num = mysql_num_rows($s);
                                  if($num < 1){
                                 ...
                                 <h3>Expenditure</h3>
                                    ...
                                    <div class="row">
                                    <?php
                                    $a = mysql_query("select sum(cost) as total_expenses from tms_expenses where month = '".$_SESSION['month']."'");
