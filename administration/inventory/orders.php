                    ...
                    <h2><span class="fa fa-share"></span> Reports</h2>
                       <div class="row" style="margin-left: 50px">
                              <form action="" method="POST">
                                          ...
                                          <div class="col-md-3">
                                          <button class="btn btn-default" name="Search_date">Search</button>
                                          </div>
                                         </form>
                                          <form action="" method="POST">
                                          <div class="col-md-2">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel-heading">
                                ...
                                <div class="panel-body">
                                 <?php
                                 $date = date('Y-m-d');
                                 $s = mysql_query("select * from tms_items, tms_orders where tms_orders.prod_id = tms_items.id and tms_orders.date = '$date'");
                                  $num = mysql_num_rows($s);
                                  if($num < 1){
                                   ?>
                                   <center><h3>Customer Orders Report On <?php echo date('Y-m-d'); ?></h3></center>
                                   <hr> 
                                   <div class='alert alert-warning'><center>No orders yet...!</center></div>
                                  <?php
                                  }else{
                                 ?>
                                 <div id="content">
