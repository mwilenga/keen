...
session_start();
 ...
 $pri = $s['s_price'];
  ...
  if(isset($_POST['order'])){
    ...
    // $sel = mysql_query("select * from tms_tempe_order,tms_items where productID = id and productID = '$id' and address = '".$_SESSION['ip']."' ");
...
//       mysql_query("update tms_tempe_order set qnt = '$sum', cos = '$su' where address = '".$_SESSION['ip']."' ");
//     } 
}
